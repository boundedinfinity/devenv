...
func bindataGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "bindata.go", size: 0, mode: os.FileMode(420), modTime: time.Unix(1479970554, 0)}
...
func userConfigDevenvAvailableFishScriptsDGoFish() (*asset, error) {
	...
	info := bindataFileInfo{name: "user/config/devenv/available/fish/scripts.d/go.fish", size: 89, mode: os.FileMode(420), modTime: time.Unix(1479970497, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
